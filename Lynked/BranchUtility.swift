...
//    branchUniversalObject.addMetadataKey(BranchKeys.code, value: promoCode) // old?
    branchUniversalObject.contentMetadata.customMetadata[BranchKeys.code] = promoCode // new?
